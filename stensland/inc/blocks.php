...
/**
 * Register only the blocks we actually use.
 * Styles come from assets/css/main.css (enqueued in functions.php).
 */
add_action('acf/init', function () {
  if ( ! function_exists('acf_register_block_type') ) return;

  // Helper to resolve template paths from theme root
  ...
  // 3) Audits Section  (keep slug used earlier: audits-buckets)
  acf_register_block_type([
    'name'            => 'audits-buckets',
